...
#ifndef BACKEND_ENGINE_SRC_CONTAINER_DARRAY_H
#define BACKEND_ENGINE_SRC_CONTAINER_DARRAY_H
...
#define darray_clear(array)  _darray_field_set(darray,DARRAY_LENGTH,0);
...
#endif //BACKEND_ENGINE_SRC_CONTAINER_DARRAY_H
